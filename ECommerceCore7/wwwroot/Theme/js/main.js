(function ($) {
    ...
    *****************************/
    ...
    $('.product-default-slider-4grids-1row').slick({
        ...
        easing: 'ease-out',
        speed: 1000,
        prevArrow: '<button type="button" class="default-slider-arrow default-slider-arrow--left prevArrow"><i class="fa fa-angle-right"></button>',
        nextArrow: '<button type="button"  class="default-slider-arrow default-slider-arrow--right nextArrow"><i class="fa fa-angle-left"></button>',
        responsive: [
    ...
    ************************************/
    ...
    $('.product-image-thumb-horizontal').slick({
        ...
        prevArrow: '<button type="button" class="gallery-nav gallery-nav-horizontal gallery-nav-horizontal-left prevArrow"><i class="fa fa-angle-right"></i></button>',
        nextArrow: '<button type="button"  class="gallery-nav gallery-nav-horizontal gallery-nav-horizontal-right nextArrow"><i class="fa fa-angle-left"></i></button>',
        responsive: [
            {
                breakpoint: 1200,
                settings: {
