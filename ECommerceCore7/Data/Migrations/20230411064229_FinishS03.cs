...
{
    /// <inheritdoc />
    public partial class FinishS03 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductGroupTitle = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProductGroupImageFilename = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleNormalizedName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "RoleID", "ConcurrencyStamp", "RoleName", "RoleNormalizedName" },
                values: new object[] { 1, null, "Admin", "مدیران سایت" });
